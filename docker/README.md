...
docker run -d --name ch-jdbc-bridge -p9019:9019 \
    ...
    -e JDBC_DRIVERS="org/mariadb/jdbc/mariadb-java-client/2.7.4/mariadb-java-client-2.7.4.jar,org/postgresql/postgresql/42.7.7/postgresql-42.7.7.jar" clickhouse/jdbc-bridge
```
